...
_SYS_REVIEW_INTENT = (
    ...
    "works'. Only choose this when a plan is actually being held AND the message "
    "clearly assents to it.\n"
    ...
    "ASYMMETRIC CAUTION — this is the crux. Getting 'approve' or "
    "'autonomy_grant' WRONG lets unreviewed code through, so NEVER invent them "
    "on an uncertain or ambiguous message: when in doubt about approve or "
    "autonomy, choose none. Getting 'request_review' wrong only costs a "
